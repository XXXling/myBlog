...
public class BackLinkController {
    ...
    public ModelAndView linkList()  {
        ...
        List<BlogLink> linkList = linkService.listLink(null);
    ...
    public String insertLinkSubmit(BlogLink link)  {
    ...
    public ModelAndView editLinkView(@PathVariable("id") Integer id)  {
        ...
        BlogLink linkCustom =  linkService.getLinkById(id);
    ...
    public String editLinkSubmit(BlogLink link)  {
        link.setLinkUpdateTime(new Date());
