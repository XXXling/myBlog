...
import com.huining.ssm.blog.enums.PageStatus;
...
public class BackPageController {
    ...
    public ModelAndView index() {
        ...
        List<BlogPage> pageList = pageService.listPage(null);
    ...
    public String insertPageSubmit(BlogPage page) {

        //判断别名是否存在
        BlogPage checkPage = pageService.getPageByKey(null, page.getPageKey());
        if (checkPage == null) {
    ...
    public ModelAndView editPageView(@PathVariable("id") Integer id) {
        ...
        BlogPage page = pageService.getPageById(id);
    ...
    public String editPageSubmit(BlogPage page) {
        BlogPage checkPage = pageService.getPageByKey(null, page.getPageKey());
        //判断别名是否存在且不是这篇文章
