...
import com.huining.ssm.blog.enums.MenuLevel;
...
public class BackMenuController {
    ...
    public String insertMenuSubmit(BlogMenu menu)  {
    ...
    public ModelAndView editMenuView(@PathVariable("id") Integer id)  {
        ...
        BlogMenu menu =  menuService.findMenuById(id);
    ...
    public String editMenuSubmit(BlogMenu menu)  {
