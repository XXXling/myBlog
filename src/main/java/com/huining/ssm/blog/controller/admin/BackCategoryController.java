...
public class BackCategoryController {
    ...
    public ModelAndView categoryList()  {
        ...
        List<BlogCategory> categoryList = categoryService.listCategoryWithCount();
    ...
    public String insertCategorySubmit(BlogCategory category)  {
    ...
    public String editCategorySubmit(BlogCategory category)  {
